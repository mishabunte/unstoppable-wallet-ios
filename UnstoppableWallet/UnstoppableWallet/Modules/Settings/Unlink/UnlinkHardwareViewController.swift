...
class UnlinkHardwareViewController: ThemeActionSheetController {
    ...
    override func viewDidLoad() {
        ...
        descriptionView.text = "settings_manage_keys.delete.confirmation_hardware".localized
        ...
        deleteButton.setTitle("settings_manage_keys.delete.confirmation_hardware.button".localized, for: .normal)
