...
class UnlinkHardwareWalletViewController: ThemeActionSheetController {
    ...
    override func viewDidLoad() {
        ...
        descriptionView.text = "Do you want to unlink this hardware wallet?"
        ...
        deleteButton.setTitle("Unlink Wallet", for: .normal)
