...
class ChooseHardwareCoinService {
    ...
    private(set) var items = [HardwareModule.Item]()
    ...
    private func btcItems() -> [HardwareModule.Item] {
...
extension ChooseHardwareCoinService: IChooseHardwareService {
